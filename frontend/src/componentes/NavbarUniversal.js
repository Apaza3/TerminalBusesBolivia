        ...
        <>
            <nav style={{
                ...
                <div className="nav-desktop" style={{ display: 'flex', alignItems: 'center', gap: '0.15rem', flex: 1, justifyContent: 'center' }}>
                    ...
                    <button onClick={() => navigate('/buscar')} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginLeft: 'auto' }}>
                    ...
                    <div className="nav-desktop" style={{
                        ...
                        border: `1px solid ${tema.primary}55`,
                        borderRadius: 8,
                    ...
                    {/* Dept badge */}
                    <button className="nav-desktop" onClick={() => navigate('/')} style={{
            ...
            {menuMovil && (
                <div className="nav-movil-menu" style={{
                    ...
                    <button onClick={() => { navigate('/'); setMenuMovil(false); }} style={{
                        display: 'flex', alignItems: 'center', gap: '0.4rem',
                        background: `linear-gradient(90deg, ${c1}20, ${c2}15)`,
                        border: `1px solid ${c1}45`, color: ac,
                        padding: '0.5rem 0.75rem', borderRadius: 20,
                        cursor: 'pointer', fontSize: '0.82rem', fontWeight: 600,
                        alignSelf: 'flex-start', outline: 'none',
                    }}>
                        <span>{DEPARTAMENTOS[departamento]?.emoji}</span>
                        <span>{departamento}</span>
                    </button>
                    ...
                    <button onClick={() => { navigate('/buscar'); setMenuMovil(false); }} style={{
                        background: `linear-gradient(135deg, ${tema.primary}, ${tema.secondary})`,
                        color: tema.primaryText, border: 'none', borderRadius: 999,
            ...
            <style>{`
                @media (max-width: 640px) {
                    ...
                    .nav-auth-btn { font-size: 0.72rem !important; padding: 0.28rem 0.6rem !important; }
                }
