...
const AdminLayout = () => {
    ...
    const btn = (active) => ({
        ...
        border: active ? `1px solid ${tema.bandera1}40` : '1px solid transparent',
        cursor: 'pointer', fontSize: '0.84rem', textAlign: 'left', width: '100%',
        transition: 'all 0.15s',
        background: active ? `linear-gradient(90deg, ${tema.bandera1}20, ${tema.bandera2}12)` : 'transparent',
        color: active ? tema.success : `${tema.success}55`,
                ...
                <aside style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: '0.85rem', fontWeight: 700, color: tema.success, lineHeight: 1.2 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', paddingLeft: '0.5rem', marginBottom: '0.2rem' }}>
                        <span style={{ fontSize: '0.6rem', color: '#334155', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Operaciones</span>
                        {notifCount > 0 && (
